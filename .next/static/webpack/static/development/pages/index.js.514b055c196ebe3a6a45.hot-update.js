  ...
  function Home() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleGallery", function () {
      ...
      if (!curationOpen) {
        ...
        mainToHome.to(document.querySelector('.wave-container'), 1, {
          yPercent: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 1), // 	Show
        mainToHome.to(document.querySelector('.text-wrap'), 0.5, {
          display: 'flex',
          opacity: 1,
          y: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 1.2), mainToHome.to(document.querySelector('.logo-text, .line'), 0.5, {
          display: 'block',
          opacity: 1,
          y: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
...
//# sourceMappingURL=index.js.514b055c196ebe3a6a45.hot-update.js.map
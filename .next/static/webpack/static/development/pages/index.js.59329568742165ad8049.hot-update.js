    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startTimer", function (_ref) {
      ...
      _this.timer = setInterval(function () {
        return _this.setState({
          ...
          var currentProgress = _this.computeProportionalWidth(playbackTimeline, _this.state.time, _this.state.currentTrack.sound.duration());

          progress.style.width = "".concat(currentProgress, "%");
          progressBall.style.left = "".concat(currentProgress, "px");
        });
      }, 1);
    });
  ...
  _createClass(MusicPlayer, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
        ...
        __self: this
      }, this.formatTime(this.time.time)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        __self: this
      }, this.formatTime(Math.round(this.state.currentTrack.sound.duration())), "`"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
//# sourceMappingURL=index.js.59329568742165ad8049.hot-update.js.map
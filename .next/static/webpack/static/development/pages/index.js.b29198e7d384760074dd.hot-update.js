    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "toggleGallery", function () {
      ...
      if (!curationOpen) {
        ...
        mainToHome.fromTo($('.curator_title_wrapper'), 0.5, {
          ...
          x: 30,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 0.2), mainToHome.fromTo($('.curator_list'), 0.5, {
          opacity: 1,
          display: 'block',
          x: 0
        }, {
          ...
          display: 'none',
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 0.5), mainToHome.to($('.back_btn'), 0.5, {
          display: 'none',
          opacity: 0,
          x: 15,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 0.5), mainToHome.to($('#curator'), 0, {
          display: 'none',
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 1), // Background Up
        ...
        mainToHome.to($('.text-wrap'), 0.5, {
          ...
          y: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
        }, 1.2), mainToHome.to($('.logo-text, .line'), 0.5, {
          display: 'block',
          opacity: 1,
          y: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_2__["Power2"].easeInOut
...
//# sourceMappingURL=index.js.b29198e7d384760074dd.hot-update.js.map
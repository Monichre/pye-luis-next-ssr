...
var external_howler_ = __webpack_require__(12);
...
function (_Component) {
  ...
  function MusicPlayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "computeProportionalWidth", function (playbackTimeline, time, duration) {
      var playbackWidth = playbackTimeline.offsetWidth;
      var ratio = time / duration;
      return "".concat(ratio);
    });

    _defineProperty(_assertThisInitialized(_this), "startTimer", function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "playCurrentTrack", function (e) {
      e.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_this), "makeCurrentTrack", function (track) {
      var currentTrack = _this.state.currentTrack;
    ...
    _defineProperty(_assertThisInitialized(_this), "nextSong", function () {});

    _defineProperty(_assertThisInitialized(_this), "previousSong", function () {});

    _defineProperty(_assertThisInitialized(_this), "pause", function (e) {
      e.preventDefault();
      var currentTrack = _this.state.currentTrack;
...
function (_Component) {
  ...
  function Home() {
    ...
    pages_defineProperty(pages_assertThisInitialized(_this), "state", {
      menuOpen: false,
    ...
    pages_defineProperty(pages_assertThisInitialized(_this), "toggleFullPlayer", function () {
    ...
    pages_defineProperty(pages_assertThisInitialized(_this), "handleDim", function () {
      external_gsap_["TweenMax"].to('.dim', 0.5, {
        opacity: 0,
        display: 'none',
        ease: external_gsap_["Power2"].easeInOut
    ...
    pages_defineProperty(pages_assertThisInitialized(_this), "revealPlayButton", function () {
